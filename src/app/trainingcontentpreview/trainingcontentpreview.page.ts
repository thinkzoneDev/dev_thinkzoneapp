...
@Component({
  selector: "app-trainingcontentpreview",
  templateUrl: "./trainingcontentpreview.page.html",
  styleUrls: ["./trainingcontentpreview.page.scss"],
})
export class TrainingcontentpreviewPage implements OnInit {
  userid: string;
  username: string;
  language: string;
  moduleid: any;
