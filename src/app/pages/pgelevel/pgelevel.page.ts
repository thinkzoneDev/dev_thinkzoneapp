...
@Component({
  selector: 'app-pgelevel',
  templateUrl: './pgelevel.page.html',
  styleUrls: ['./pgelevel.page.scss']
})
@NgModule({
  declarations: [],
  imports: []  
})
export class PgeLevelPage {
  slideOpts :any;
  ...
  set_level_list(){
    this.level_list = [
      ...
      {value:'4', text: "level4" , disabled: false},
      {value:'5', text: "level5" , disabled: false},
    ];
  }
  level_onchange(value){
    const navigationExtras: NavigationExtras = {
      queryParams: {
        parameters: {"program":this.alldata.program,"stage":this.alldata.stage,"subject":this.alldata.subject,"level":value}
      }
    };
