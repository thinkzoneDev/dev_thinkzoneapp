...
export class PgactivityengPage {
  ...
  pageload(){
    // this.month_list = [
    //   {value:'1', text: this.skill1_4  , disabled: false, subject: 'english'}, 
    //   {value:'2', text: this.skill5_8  , disabled: false, subject: 'english'},
    //   {value:'3', text: this.skill9_12 , disabled: false, subject: 'english'},
    //   {value:'4', text: this.skill13_16, disabled: false, subject: 'english'},
    //   {value:'5', text: this.skill17_20, disabled: false, subject: 'english'}
    // ];
  }
