...
const AccoedCnew = ({
  ...
  let contentDetails = useSelector(
    state => state.trainingdataNew.pptcontentDetails,
  );
  let userContentDetails = useSelector(
    state => state.trainingdataNew.pptuserdetails,
  );
  ...
  const topicClicked = (topic, c_type, item) => {
    // setIsLoading(true);
    console.log(c_type, 'topic------------->');
    if (c_type == 'assignment') {
      ...
      navigation.navigate('preprogram_training_content_new', {
        data: topic,
        data_type: c_type,
        whole_data: item,
      });
      ...
      //   API.get(
      //     `ppt_trans_gettopicData/${user[0].userid}/${topic.moduleid}/${topic.submoduleid}/${topic.topicid}`,
      //   )
      //     .then(res1 => {
      //       const data = res1.data;
    ...
    <>
      <View style={styles.container}>
        ...
        {usercontentDetails?.map((item, index) => {
          console.log('item content ppt-->', item);
          return (
            <ScrollView>
                                    ...
                                    {topic.contentStatus == 'complete' ? (
                                      <View
                                        ...
                                        <TouchableOpacity
                                          ...
                                          onPress={() =>
                                            topicClicked(topic, 'content', item)
                                          }>
