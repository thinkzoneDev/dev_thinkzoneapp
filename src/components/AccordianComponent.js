...
const AccordianComponent = ({
  ...
  let contentDetails = useSelector(state => state.trainingdata.contentDetails);
  ...
  const topicClicked = (topic, c_type) => {
    ...
    if (c_type == 'assignment') {
      navigation.navigate('monthlytraining_assignment', {
        data_type: c_type,
        data: topic,
      });
    } else {
                          ...
                          {toicindex === topicIndex && (
                            <View
                              ...
                              {topic.quiz_status ? (
                                ...
                                <View style={styles.conquiz}>
                                  <TouchableOpacity
                                    onPress={() => topicClicked(topic, 'quiz')}>
                                    <Text style={{color: 'black'}}>Quiz</Text>
                                  </TouchableOpacity>
                                </View>
                              )}

                              {topic.assignmentStatus ? (
                                <View
                                  style={[
                                    styles.conquiz,
                                    {
